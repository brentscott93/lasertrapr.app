...
Open R/RStudio on your computer. You can download the developers version of the app from Github with the following code. Copy/paste the following into the R-Console or into an R-Script to run:  
